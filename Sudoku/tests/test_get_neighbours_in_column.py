...
from sudoku.helpers import CellIndex, get_neighbours_in_column
...
def test_get_neighbours_in_column(cell: CellIndex, expected_result: CellIndex) -> None:
    # Act
    result = get_neighbours_in_column(cell)
