...
from sudoku.helpers import CellIndex, get_neighbours_in_row
...
def test_get_neighbours_in_row(cell: CellIndex, expected_result: CellIndex) -> None:
    # Act
    result = get_neighbours_in_row(cell)
