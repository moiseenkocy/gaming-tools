...
from sudoku.helpers import CellIndex, get_cells_in_box
...
def test_get_cells_in_box(cell: CellIndex, expected_result: CellIndex) -> None:
    # Act
    result = get_cells_in_box(cell)
